...
model_1d = 'ct1.dat';
model_3d = 'ct1_spectrum_enh.dat';
casename = 'MCMC_response_TD32';
% model_1d = 'ct1.dat';
...
Flag.IS_D_LD = 1;       % consider lateral heterogeneity in lambda (1) or not (0)
Flag.IS_D_RHO = 1;      % consider lateral heterogeneity in rho (1) or not (0)
